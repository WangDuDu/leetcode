 ...
 * dp[2] = 2
 *      num = 3 dp[2] = dp[2] = 0
 *      num = 2 dp[2] = dp[2] + dp[0] = 1
 *      num = 1 dp[2] = dp[2] + dp[1] = 2
 * dp[3] = 4
 *      num = 3 dp[3] = dp[3] + dp[0] = 1
 *      num = 2 dp[3] = dp[3] + dp[1] = 2
 *      num = 1 dp[3] = dp[3] + dp[2] = 4
 * dp[4] = 7
 *      num = 3 dp[4] = dp[4] + dp[1] = 1
 *      num = 2 dp[4] = dp[4] + dp[2] = 3
 *      num = 1 dp[4] = dp[4] + dp[3] = 7
